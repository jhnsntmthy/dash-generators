...
class TestDashLayoutGenerator < Test::Unit::TestCase
  ...
  context "generator with haml option" do
    rails_generator :dash_layout, "foobar", :haml => true
